...
export const ThagdaLoader = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-slate-950/95 backdrop-blur-2xl transition-all duration-300 ${
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center">
        ...
        <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-full border-2 border-dashed border-indigo-500/30 animate-[spin_8s_linear_infinite] absolute flex items-center justify-center">
          <div className="w-3 h-3 rounded-full bg-indigo-400 absolute -top-1.5 shadow-lg shadow-indigo-500/80" />
          <div className="w-2.5 h-2.5 rounded-full bg-emerald-400 absolute -bottom-1 shadow-lg shadow-emerald-500/80" />
        </div>

        {/* Inner Counter-Rotating Ring 2 */}
        <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full border-2 border-emerald-500/30 border-t-emerald-400 border-b-indigo-400 animate-[spin_4s_linear_infinite_reverse] absolute flex items-center justify-center">
          <div className="w-2 h-2 rounded-full bg-amber-400 absolute -right-1 shadow-md shadow-amber-400" />
        </div>

        {/* Glowing Pulsing Circle */}
        <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-emerald-400 p-0.5 shadow-2xl shadow-indigo-500/40 relative z-10 flex items-center justify-center animate-pulse">
          <div className="w-full h-full bg-slate-950 rounded-[22px] flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="text-2xl sm:text-3xl font-black font-mono tracking-wider bg-gradient-to-r from-indigo-400 via-sky-300 to-emerald-300 bg-clip-text text-transparent drop-shadow-md">
              4H
            </div>
            <div className="text-[8px] font-black uppercase tracking-widest text-emerald-400 mt-0.5">
              HISAB
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 text-center space-y-1.5 relative z-10 px-4">
        <div className="flex items-center justify-center gap-2">
          <span className="text-base sm:text-lg font-black tracking-wide text-white uppercase">
      ...
      <div className="w-64 sm:w-80 mt-6 space-y-2 relative z-10">
        ...
        <div className="flex items-center justify-between text-[11px] font-mono">
          <span className="text-slate-400 truncate max-w-[200px] flex items-center gap-1.5">
      ...
      {/* Bottom Secure Badge */}
      <div className="absolute bottom-8 flex items-center gap-2 text-[10px] text-slate-500 font-medium uppercase tracking-widest">
