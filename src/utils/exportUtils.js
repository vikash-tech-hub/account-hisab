...
export const exportTransactionsToCSV = (transactions, portalsMap, filename = 'Daily_Transactions.csv') => {
...
export const exportCustomerLedgerToCSV = (customers, filename = 'Customer_Ledger.csv') => {
  if (!customers || customers.length === 0) {
    console.warn('No customers to export.');
    return false;
  }

  const headers = ['Customer ID', 'Name', 'Phone', 'Address / Reference', 'Total deposits (Rs)', 'Total withdrawals (Rs)', 'Net Balance (Rs)', 'Status'];
...
📊 *Account Summary:*
• Total deposits: ${formatINR(customer.totalJama || 0)}
• Total withdrawals: ${formatINR(customer.totalLiya || 0)}
--------------------------------
${balanceText}
--------------------------------
📜 *Recent Transactions:*
...
• Cash deposits: +${formatINR(summary.totalJamaCash)}
• Cash payouts: -${formatINR(summary.totalLiyaCash)}
...
--------------------------------
_Generated by Maa Vaishno Enterprises_`;
